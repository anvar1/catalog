...
public class CatalogTestContainer extends TestContainer {

    public CatalogTestContainer() {
        super();
    ...
    public static class Common extends CatalogTestContainer {

        public static final CatalogTestContainer.Common INSTANCE = new CatalogTestContainer.Common();
